...
export const NAV_CATEGORIES: NavCategory[] = [
  {
    ...
    items: [
      ...
      { i18nKey: 'unixTime',    label: 'Unix Timestamp',     path: '/unix-time',   icon: Clock,          description: 'Convert between Unix timestamps and dates' },
    ],
  },
  {
    label: 'Text Tools',
  ...
  },
  {
    ...
    items: [
      ...
      { i18nKey: 'jsonTs',        label: 'JSON → Class',      path: '/json-ts',       icon: FileCode,      description: 'Generate classes for TS, C#, Java, Python, Go, Rust' },
      { i18nKey: 'qrScan',        label: 'QR Code Scanner',   path: '/qr-scan',       icon: QrCode,        description: 'Scan QR codes from images' },
      { i18nKey: 'fakeJson',      label: 'Fake JSON',          path: '/fake-json',     icon: Sparkle,       description: 'Generate random JSON objects from presets or a schema' },
    ],
  },
  {
    label: 'Generators',
